...
public class VideoClassesFragment extends Fragment {
    ...
    private VideoClassesViewModel mViewModel;

    public static VideoClassesFragment newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(VideoClassesViewModel.class);
